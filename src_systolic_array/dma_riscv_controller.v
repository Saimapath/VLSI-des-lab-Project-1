...
module controller(
    input  [6:0] op,
    input  [2:0] funct3,
    input  [6:0] funct7,       // ---> CHANGED: Pass the full 7 bits instead of just funct7b5   
    output reg   regwrite, 
    ...
    output reg dma_mac_en      // ---> NEW: DMA trigger flag

);

    wire funct7b5 = funct7[5]; // Keep this for your existing ALU logic compatibility
...
// MemWrite Decoder (Handles sb, sh, sw)
    ...
    //  Decode MATMAC here in the integer controller
    always @(*) begin
