...
module fpu_tb();
    ...
    localparam FP16_0_0     = 16'h0000; localparam FP16_NEG_0_0 = 16'h8000;
    localparam FP16_0_5     = 16'h3800; localparam FP16_NEG_0_5 = 16'hB800;
    localparam FP16_1_0     = 16'h3C00; localparam FP16_1_5     = 16'h3E00;
    localparam FP16_2_0     = 16'h4000; localparam FP16_NEG_2_0 = 16'hC000;
    localparam FP16_3_0     = 16'h4200; localparam FP16_NEG_3_0 = 16'hC200;
    localparam FP16_4_0     = 16'h4400; localparam FP16_5_0     = 16'h4500;
    localparam FP16_NEG_5_0 = 16'hC500; localparam FP16_6_0     = 16'h4600;
    localparam FP16_10_0    = 16'h4900; localparam FP16_NEG_10_0= 16'hC900;
    localparam FP16_INF     = 16'h7C00; localparam FP16_NEG_INF = 16'hFC00;
    ...
    task check_mac_op;
        ...
        begin
            ...
            // ---> UPDATED: Wait 3 clock cycles for the deeper pipeline!
    ...
    initial begin
        ...
        $display("\n==========================================================");
        $display(" RUNNING COMPREHENSIVE FPU TEST SUITE (3-STAGE MAC)");
        $display("==========================================================\n");
        ...
        check_comb_op("FCVT.W.S:  1.5 -> Int 1    ", FPU_FCVT_W_S,  3'b000, FP16_1_5,     16'd0, 32'd0, 16'd0, 32'd1, 1);
        check_comb_op("FCVT.W.S: -2.0 -> Int -2   ", FPU_FCVT_W_S,  3'b000, FP16_NEG_2_0, 16'd0, 32'd0, 16'd0, 32'hFFFFFFFE, 1);
        check_comb_op("FCVT.WU.S: -2.0 -> Int 0   ", FPU_FCVT_WU_S, 3'b000, FP16_NEG_2_0, 16'd0, 32'd0, 16'd0, 32'd0, 1);
        ...
        $display("\n==========================================================");
        if (errors == 0) $display(" [SUCCESS] ALL %0d TESTS PASSED!", tests_run);
        else $display(" [WARNING] %0d OUT OF %0d TESTS FAILED.", errors, tests_run);
        $display("==========================================================\n");
